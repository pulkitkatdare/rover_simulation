...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'video_stuff' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dhruv-shah/ros_ws/rover_simulation/autonomous_ws/install/${idir}'.  Ask the maintainer 'dhruv-shah <dhruv-shah@todo.todo>' to fix it.")
    endif()
